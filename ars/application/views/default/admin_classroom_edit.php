      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="<?php echo base_url() ?>index.php/admin_classroom_edit">自动排课 <span class="sr-only">(current)</span></a></li>
            <li><a href="<?php echo base_url() ?>index.php/r2/Search">查询与打印</a></li>
          </ul>
        </div>
