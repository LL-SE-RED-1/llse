...
class R3_Teacher extends CI_controller{ 
	...
	public function curriculum($tid){
		...
		$data['classnum'] = $n;
		$this->load->view('r3_t_curriculum',$data); //加载新的视图，并且把结果传过去
	}
	...
	public function classmember($cid){
		...
		$this->load->view('r3_t_classmember',$data); //加载新的视图，并且把结果传过去
	...
	public function courseinfo($cid = '0'){
		...
		$this->load->view('r3_t_courseinfo',$data); //加载课程简介的视图，并且把结果传过去
	}
	...
	public function selectengine($tid = '0'){
		...
		$this->load->model('r3_Course_model', 'coursem'); //加载course_model
		$this->load->model('r3_Curriculum_model','Curriculum_model'); //加载curriculum_model
		...
		$this->load->view('r3_t_selectengine', $data); //加载搜索引擎的视图，并且把结果传过去
	}
	//教师用户进入系统时，先调用index，显示教师的首页
	public function index(){
 		$this->load->view('r3_t_homepage'); //加载教师的首页
	}
