        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-2 main">
          ...
          <form action="Search" method="post" id = "fo">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <!--教师姓名查询-->
                <input type="text" class="form-control" id="courseid" name="tc_id" required="" autofocus=""placeholder="请输入教师姓名...">
              </div> 
              <div class="col-sm-0">
              </div>
        ...
        <?php endforeach*/ ?>
                ...
                <tbody>
                  ...
                  for($j = 1;$j <= 7;$j++){
                    echo "<td>";
                    //判断是不是在该格显示
                    foreach ($search as $schedule_item) {
                      if ($schedule_item['weekday']==$j && $schedule_item['classnum'][$i]==1) echo $schedule_item['course_name'];
                    }
                    echo "</td>";
                  }
                  echo "</tr>";
