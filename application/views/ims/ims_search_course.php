            ...
            <form class="ui form" action="<?php echo site_url('ims/ims_search_course/search')?>" method="post">
                <div class="ui left labeled icon input">
                    <div class="ui teal dropdown label">
                        ...
                        <input name="var" type="hidden" value="course_id">
                        <div class="menu">
                            <div class="item" data-value="course_id">编号</div>
    ...
    <div class="col-xs-6 col-sm-12">
        <table class="ui striped table">
            ...
            <tbody>
                ...
                <tr>
                    <form class="ui form" action="<?php echo site_url('ims/ims_add_course') . "/" . "index/" . $item['course_id'] . '/1'?>" method="post">
