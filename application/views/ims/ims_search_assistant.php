        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="col-xs-6 col-sm-6 huge-placeholder">
            ...
            <h2 class="sub-header">搜索助管</h2>

          </div>
            <div class="col-xs-6 col-sm-6">
                <div class="ui right floated transparent-seg segment">
                    <form class="ui form" action="<?php echo site_url('ims/ims_search_assistant/search')?>" method="post">
                        <div class="ui left labeled icon input">
                            <div class="ui teal dropdown label">
                                <div class="text">助管号</div>
            ...
            <table class="ui striped table">
                ...
                <tr>
                    <form action="<?php echo site_url('ims/ims_add_assistant') . "/" . "index/" . $item['uid'] . '/1'?>" method="post">
            ...
            <?php endif;?>
                ...
                <br>
                <form action="<?php echo site_url('ims/ims_add_assistant')?>" method="post">
                <button class="ui right floated primary labeled icon button" type="submit">
                    <i class="user icon"></i> 添加助管
                </button>
                </form>
        </div>
      </div>
