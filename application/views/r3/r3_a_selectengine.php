  ...
  <body>
	...
	<?php include 'application/views/r3/r3_a_sidebar.php';?>
      ...
      <div class="col-sm-12 col-md-12  table-responsive">
        <form role="form" action="<?php echo site_url('r3/r3_admin/selectengine');?>" method="post">
          <table class="table">
           <tr>
                  ...
                  <tbody>
                    <?php
                      for($i=1;$i<=$coursenum;$i++){
                        if($i%2==1){
                          echo '<tr><td><a href=';
                          echo site_url('r3/r3_admin/courseinfo/'.$courseid[$i]);
                          echo '>';
                          echo $coursename[$i];
                          echo '</a></td><td>';
                          echo $courseid[$i];
                          echo '</td><td><button class="btn btn-default" formaction=';
                          echo site_url("r3/r3_admin/selectpage/".$courseid[$i]);
