  ...
  <body>
	...
	<?php include 'application/views/r3/r3_a_sidebar.php';?>
	  ...
	  <?php include 'application/views/r3/r3_a_circles.php'; ?>
            ...
            <h1>增加/删除学生</h1>
            <form role="form" action="<?php echo site_url('r3/r3_admin/classmember/'.$classid);?>" method="post">
                    ...
                    <?php
                      for($i=1;$i<=$searchnum;$i++){
                        ...
                        if($classselect[$i]==1){
                            ...
                            echo site_url("r3/r3_admin/modifyclass/".$searchid[$i].'/'.$classid.'/0');
                            echo '>删除</button></td>';
                        }
                        else{
                            echo '<button class="btn btn-default" formaction=';
                            echo site_url("r3/r3_admin/modifyclass/".$searchid[$i].'/'.$classid.'/1');
                            echo '>添加</button></td>';
                        }
                        echo '</tr>';
                      }
