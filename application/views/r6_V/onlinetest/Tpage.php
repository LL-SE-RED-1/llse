...
<h1>在线测试-考试管理</h1>
<?php echo 'Your tid is '.$this->session->userdata['tid'].'.<br>' ?>
<form action='<?php echo site_url('/r6_C/onlinetesting/creat_exam'); ?>'  method='post'>
Class	:<select name='cid' value=''>
<?php
	foreach($cids as $cid){
		echo "<option value=".$cid->class_id.">".$cid->class_id."</option>";
	}
?>
</select><br>
INFO	:<input name='info' type='text' /><br>
Paper	:<select name='pid' value=''>
<?php
foreach ($pap as $x=>$text){
	echo '<option value='.$x.'>'.$text.'</option>';
}
?>
</select><br>
Start	:<br>
Year	:<select name='stimeY' value=''>
<option value=2015>2015</option>
<option value=2014>2014</option>
</select><br>
Month	:<select name='stimeM' value=''>
...
End	:<br>
Year	:<select name='etimeY' value=''>
<option value=2015>2015</option>
<option value=2014>2014</option>
</select><br>
Month	:<select name='etimeM' value=''>
<option value='January'>1</option>
<option value='February'>2</option>
<option value='March'>3</option>
<option value='April'>4</option>
...
Last	:<input name='length' type='text' />mins<br>
