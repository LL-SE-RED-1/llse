...
<input class="btn btn-default" type='submit' value='在线测试'>
</form><br>
<hr/>
<h3>成绩分析</h3>
<form action='<?php echo site_url('r6_C/sa_control/view'); ?>' method = 'post'>
<input class="btn btn-default" type='submit' value='学生成绩分析'>
</form><br>
<hr/>
&copy; 红六组-在线测试组
</body>
